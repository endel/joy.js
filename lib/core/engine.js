...
(function(J) {
  ...
  var Engine = function(options) {
    ...
    /**
     * Scene to show when your current scene still loading.
     * @property loaderScene
     * @type {Scene}
     */
    ...
    this.__defineSetter__('currentScene', function(scene) {
      ...
      console.log("change currentSceneIndex => ", this._currentSceneIndex);
      scene.visible = true;
  ...
  Engine.prototype.gotoNextScene = function(milliseconds, color) {
    ...
    this.currentScene.fadeOut(milliseconds, color).bind('fadeOutComplete', function () {
      self.currentScene = self.scenes[self._currentSceneIndex+1];
